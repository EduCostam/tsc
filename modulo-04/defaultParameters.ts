...
// => Exemplo 03
function exibirNome(nome: string, sobrenome = 'Costa') {
  return nome + ' ' + sobrenome;
}
const resultado_1 = exibirNome('Eduardo');
const resultado_2 = exibirNome('Eduardo', undefined);
//const resultado_3 = exibirNome('Eduardo', 'Costa', 'Senhor');
const resultado_4 = exibirNome('Eduardo', 'Costa');
